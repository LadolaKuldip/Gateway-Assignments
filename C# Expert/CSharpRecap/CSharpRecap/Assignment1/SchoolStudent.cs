...
namespace CSharpRecap.Assignment1
{
    ...
    {
        public SchoolStudent(int id, string firstName, string lastName, int age, bool interestedInSports, bool interestedInMusic, bool isSchoolStudent, DateTime registerationTime, string address)
        {
            Id = id;
            FirstName = firstName;
            LastName = lastName;
