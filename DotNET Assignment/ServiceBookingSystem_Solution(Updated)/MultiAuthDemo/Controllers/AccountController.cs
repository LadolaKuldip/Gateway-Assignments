...
using MultiAuthDemo.Validation.Classes;
...
namespace MultiAuthDemo.Controllers
{
    ...
    public class AccountController : Controller
    {
        ...
        private readonly ICustomerMapRepository _customerMapRepository = new CustomerMapRepository();
        ...
        public string RegisterAccount(RegisterViewModel model)
        {
            ...
            if (ModelState.IsValid)
            {
                ...
                if (result.Succeeded)
                {
                    var response = _customerMapRepository.MapDealer(model, user.Id);

                    string FilePath = "D:/Projects/DealerMail.html";
                    StreamReader str = new StreamReader(FilePath);
                    string MailText = str.ReadToEnd();
                    MailText = MailText.Replace("{UserName}", model.UserName);
                    MailText = MailText.Replace("{Password}", pass);

                    MailMessage mail = new MailMessage();
                    mail.To.Add(model.Email);
                    mail.From = new MailAddress("automobile.onthego@gmail.com");
                    mail.Subject = "Login Credentials for ASCP!";
